...
def add_to_dict(my_dict, word=None, definition=None):
  if type(my_dict) is not dict:
    print("You need to send a dictionary. You sent:", type(my_dict))

  elif (word is None) or (definition is None):
...
def get_from_dict(my_dict, word=None):
  if type(my_dict) is not dict:
    print("You need to send a dictionary. You sent:", type(my_dict))
...
def update_word(my_dict, word=None, definition=None):
  if type(my_dict) is not dict:
    print("You need to send a dictionary. You sent:", type(my_dict))
    ...
    if word in my_dict:
      ...
      print(f"{word} is not in this dict. Can’t update non-existing word.")
  

def delete_from_dict(my_dict, word=None):
  if type(my_dict) is not dict:
    print("You need to send a dictionary. You sent:", type(my_dict))
